...
class _FriendDetailState extends State<FriendDetail> {
  ...
  Widget build(BuildContext context) {
    var main = Scaffold(
                      ...
                      children: <Widget>[
                        InkWell(
                            onTap: () {
                              ...
                              showToast("微信:设置备注及标签");
                            },
                            child: ListTile(
                                leading: ImageIcon(AssetImage(
                                    "assets/icons/ofm_remarks_icon.png")),
                                title: Text("设置备注及标签"))),
                        InkWell(
                            onTap: () {
                              Navigator.pop(context);
                        ...
                        InkWell(
                            onTap: () {
                              Navigator.pop(context);
                              showToast("微信:设置朋友圈权限");
                            },
                            child: ListTile(
                                leading: ImageIcon(AssetImage(
                                    "assets/icons/ofm_moment_icon.png")),
                                title: Text("设置朋友圈权限"))),
                        InkWell(
                            onTap: () {
                              Navigator.pop(context);
                            ...
                            child: ListTile(
                                leading: ImageIcon(AssetImage(
                                    "assets/icons/ofm_send_icon.png")),
                                title: Text("发送名片"))),
                        InkWell(
                            onTap: () {
                              Navigator.pop(context);
                            ...
                            child: ListTile(
                                leading: ImageIcon(AssetImage(
                                    "assets/icons/ofm_reportstop_icon.png")),
                                title: Text("投诉"))),
                        InkWell(
                            onTap: () {
                              Navigator.pop(context);
                        ...
                        InkWell(
                            ...
                            child: ListTile(
                                leading: ImageIcon(AssetImage(
                                    "assets/icons/ofm_delete_icon.png")),
                                title: Text("删除"))),
                        InkWell(
                            onTap: () {
                              Navigator.pop(context);
      ...
      body: _FriendDetailBody(
        contactItemData: widget.contactItemData,
      ),
    );
    return main;
  }
...
class _FriendDetailBodyHead extends StatelessWidget {
  ...
  const _FriendDetailBodyHead({Key key, this.contactItemData})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    var assetGender = contactItemData.gender == Gender.Female
        ? "assets/icons/ic_sex_female.png"
        : "assets/icons/ic_sex_male.png";
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          GestureDetector(
            onTap: () {
              showToast('Show Photos');
            },
            child: Container(
                alignment: Alignment.centerLeft,
                child: Image.asset(contactItemData.assetsName,
                    height: 64, width: 64),
                width: 80),
          ),
          Expanded(
                  ...
                  children: <Widget>[
                    Expanded(
                      ...
                      children: <Widget>[
                        Flexible(
                            child: Container(
                                child: Text(contactItemData.name,
                                    overflow: TextOverflow.ellipsis,
                                    style: TextStyle(fontSize: 16.0)))),
                        SizedBox(
                          width: 10,
                        ),
                        Image.asset(assetGender,
                            height: 16.0,
                            width: 16.0,
                            alignment: Alignment.centerLeft),
                      ],
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Image.asset(
                          "assets/icons/circle_notreceive.png",
                          height: 16.0,
                          width: 16.0,
                        ),
                        Image.asset(
                          "assets/icons/circle_notvisible.png",
                          height: 16.0,
                          width: 16.0,
                        ),
                      ],
